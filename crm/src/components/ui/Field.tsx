...
/** Label above and always visible — never a placeholder standing in for one.
 *  The helper line is reserved whether or not there is an error, so validation
 *  never shifts the layout (DESIGN.md §5, §9). */
...
export function TextInput({
  ...
  return (
    <input
      ...
      aria-describedby={props.id ? `${props.id}-hint` : undefined}
      className={cn(
